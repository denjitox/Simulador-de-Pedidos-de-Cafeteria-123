...
- Puedes abrir `diagram.mmd` en VS Code con una extensión de Mermaid o pegar su contenido en https://mermaid.live para visualizarlo.

Contactos
- Si necesitas cambios adicionales en la documentación o en el diagrama, indica qué quieres ajustar.
